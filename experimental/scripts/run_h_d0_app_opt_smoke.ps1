...
$RunRoot = Join-Path $Root "outputs\experiments\train_probes\app_opt_h_d0_$RunLabel`_$Timestamp"
...
Write-Host "Starting H_D0 app_opt run: $RunRoot"
...
$Out = Join-Path $RunRoot "h_d0_app_opt_train"
...
Write-Host ""
Write-Host "[OK] H_D0 app_opt run finished: $RunRoot"
