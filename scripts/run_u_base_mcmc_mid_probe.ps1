...
$RunRoot = Join-Path $Root "outputs\experiments\train_probes\u_base_mcmc_mid_probe_$Timestamp"
...
Write-Host "Starting U_base MCMC mid probe: $RunRoot"
...
Write-Host ""
Write-Host "[OK] U_base MCMC mid probe finished: $RunRoot"
