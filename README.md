...
- `experimental/`：研究支線，先不混入正式 coverage
...
- L0 的 Gate 0~3、Phase 0 v2 模組契約、ROI-aware selection 設計  
  -> [docs/L0洗幀管線設計.md](/C:/3d-recon-pipeline/docs/L0洗幀管線設計.md)
...
- L0 / Gate 0~3 / Phase 0 v2： [docs/L0洗幀管線設計.md](/C:/3d-recon-pipeline/docs/L0洗幀管線設計.md)
