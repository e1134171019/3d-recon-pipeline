...
| **Coverage 口徑** | `.coveragerc` + `AI代理作業守則.md § 4B Coverage 口徑` + 對應測試 / coverage 命令說明 |
...
任何主線改動的 PR 必須說明本次通過了哪幾個 Gate；**Gate 的正式定義、判定標準與流程圖不得在本檔案重寫**，一律以：

- [`docs/L0洗幀管線設計.md`](docs/L0洗幀管線設計.md)
- [`AI代理作業守則.md § 2 嚴密的 Gate 0~3 快速驗證協定`](AI代理作業守則.md)
...
- 本次驗證到哪一個 Gate
- 使用的資料集 / 子集
- 關鍵指標或證據位置（如 `pytest`、SfM 產物、short-train log、full-train metrics、Unity 驗證）
